...
@Component({
  ...
  standalone: true,
  imports: [MatInputModule, MatCheckboxModule, MatDatepickerModule, MatButtonModule],
...
export class AddEventoComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.map = new mapboxgl.Map({
        accessToken: 'pk.eyJ1IjoiYWxsb3ViZXR2ZXIxODEyIiwiYSI6ImNsY3RhZ2o5dTBqMHAzb3MxeHZzZ3lyanEifQ.2Jw1OyBFbyNkNAubvzRJeA',
        container: 'map',
  ...
  searchLocation() {
    ...
    fetch('https://api.mapbox.com/geocoding/v5/mapbox.places/' + encodeURIComponent(location) + '.json?access_token=' + this.accessTokenMapBox)
